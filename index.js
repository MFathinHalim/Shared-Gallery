          ...
          return [
            ...
            axios.post(
              "https://www.google.com/recaptcha/api/siteverify?secret="
                .concat(process.env.GOOGLE_RECAPTCHA_SECRET_KEY, "&response=")
                .concat(token)
            ),
          ];
        case 1:
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        ...
                        console.log(
                          "Berhasil mengunggah ke ImageKit:",
                          imgLink
                        );
                        comments = [];
  ...
  .then(function () {
    mainModel
      ...
      .then(function (updateResult) {
        console.log(
          "".concat(updateResult.modifiedCount, " dokumen diperbarui")
        );
      ...
      .then(function (res) {
        ...
        app.get("/:id", function (req, res) {
          ...
          var searchResult = data.find(function (entry) {
            return entry.id == searchTerm;
          });
          res.render("img", {
            data: data,
            entry: searchResult,
        ...
        app.listen(port, function () {
          console.log(
            "[app]: app is running at http://localhost:".concat(port)
          );
        });
      });
  });
